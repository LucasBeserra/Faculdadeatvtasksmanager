...
let initialRows = [
  createData(1, 'Tarefa 1', 'Assistir aula: Spring Boot MVC', '2022-01-01', '2022-01-02', 'Concluída'),
  createData(2, 'Tarefa 2', 'Assistir aula: Relacionamento entre Entidades', '2022-01-03', '2022-01-04', 'Em Andamento'),
  createData(3, 'Tarefa 3', 'Assistir aula: Repository, controller e relacionamentos', '2022-01-04', '2022-01-05', 'Em Andamento'),
  createData(4, 'Tarefa 4', 'Assistir aula: Spring Boot', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Assistir aula: Segurança no Spring Boot', '2022-01-06', '2022-01-07', 'Em Andamento'),
  createData(6, 'Tarefa 6', 'Assistir aula: Documentando a API', '2022-01-07', '2022-01-08', 'Aguardando')
];

//Componente ListarTarefa
let ListarTarefa = () => {
  let [open, setOpen] = useState(false);
  let [openEditar, setOpenEditar] = useState(false);
  let [tarefas, setTarefas] = useState([]);
  let [tarefa, setTarefa] = useState();
  let [idTarefaSelecionada, setIdTarefaSelecionada] = useState([]);
  let handleOpen = () => setOpen(true);
  let handleClose = () => setOpen(false);
  let handleCloseEditar = () => setOpenEditar(false);
